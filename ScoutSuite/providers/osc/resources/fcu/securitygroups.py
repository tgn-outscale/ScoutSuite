...
class SecurityGroups(OSCResources):
    ...
    #     {'ResponseContext':
    #     {'RequestId': '7fcf7f96-71fb-47c8-a9e9-e9798b375158'},
    #     'SecurityGroups':
    #     [
    #         {'AccountId': '392579172836',
    ...
    #             ],
    #             'OutboundRules': [],
    #             'SecurityGroupId': 'sg-ec5a5815',
    #             'SecurityGroupName': 'Test SG Foireux',
    #             'Tags': []
    #         }
    #     ]
    # }